            ...
            <div className="w-1/2 flex justify-center items-center">
                <div className="bg-[#3c596899] h-auto p-[4vw] rounded-[30px] w-[40vw]">
                    <div className="flex flex-col items-center text-[#f2efdd] gap-2 mb-3">
                        ...
                        <h1 className="text-lg text-[#f2efdd]">Content de vous revoir !</h1>
                    ...
                    >
                        ...
                        <div className=" flex items-center justify-between w-full">
                            ...
                            <Link
                                href="/login/forget"
                                className="text-[0.7rem] text-[#f2efdd] hover:text-[#574c4a]"
                            >
                                Mot de passe oublié?
                            </Link>
                        </div>
                        ...
                        <div className=" flex items-center justify-between w-full pt-2">
                            ...
                            <Link
                                href="/"
                                className="text-sm text-[#f2efdd] hover:text-[#F4555A]"
                            >
                                Quitter
                            </Link>
                        </div>
